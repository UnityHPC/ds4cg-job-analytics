...
<p><strong>VRAM Efficiency</strong>: Measures how effectively your job uses the allocated GPU memory. It's calculated as the ratio of <em>memory used</em> to <em>total memory allocated</em>. Higher values (closer to 1.0) indicate more efficient resource utilization.</p>
